...
Relevance to GDAC-SA:
- Novel schema design capability - needed for Saudi geoscience data
- Multi-source data integration expertise
- Rigorous data quality assurance (<1% deviation)
- Academic partnerships demonstrating credibility
- R&D approach with documented methodology
-->
...
| Criterion | EarthBank | Isotopes.au | LithoSpace |
|-----------|-----------|-------------|------------|
| **Type** | National infrastructure | Multi-agency R&D | Academic R&D |
| **Contract Value** | $450K+ | $300K | R&D investment |
| **Duration** | 2021-ongoing | 2024-2028 | 2024-ongoing |
| **Client Type** | NCRIS/Government | Government consortium | Academic |
| **Data Scale** | 350,000+ samples | 6 agencies | 25+ missions |
| **Users** | 1,300+ | Research community | Research community |
| **Status** | Production | Development | R&D phase |
| **Publication** | Chemical Geology 2025 | R&D reports | R&D reports |

---

## Relevance to GDAC-SA

| GDAC-SA Requirement | EarthBank Evidence | Isotopes.au Evidence | LithoSpace Evidence |
|--------------------|-------------------|---------------------|---------------------|
| Geoscience data platform | Direct match | Schema design | Schema design |
| Large-scale data management | 350K+ samples | Multi-agency integration | Multi-mission integration |
| Analytics capabilities | Dashboards, LithoPlates | Data validation | Cross-mission comparison |
| FAIR compliance | Core design principle | Metadata enrichment | Standards alignment |
| Government partnership | NCRIS/AuScope | CSIRO/ANSTO/GA/NMI | Academic partners |
| Schema design | Custom SKOS schema | Unified isotope schema | Novel planetary schema |
| API development | REST API | Programmatic access | API integration |
| Production operations | Production since 2022 | Development phase | R&D phase |
...
└─────────────────────────────────────────────────────────────────────────────┘
    ...
    ▼                               ▼                               ▼
┌─────────────────┐       ┌─────────────────┐       ┌─────────────────┐
│    EarthBank    │       │   Isotopes.au   │       │    LithoSpace   │
│                 │       │                 │       │                 │
│ 350K samples    │       │ 6 agencies      │       │ 25+ missions    │
│ SKOS vocab      │       │ harmonized      │       │ unified         │
│ 50K+ terms      │       │ 97% match       │       │ <1% error       │
└────────┬────────┘       └────────┬────────┘       └────────┬────────┘
         │                         │                         │
         └─────────────────────────┼─────────────────────────┘
                                   │
...
|--------|-------|--------------|
| **Production platform experience** | 4+ years (EarthBank since 2021) | Proven operational stability |
...
| **Data deviation from reference** | <1% (LithoSpace) | Trustworthy training data |
| **Data sources integrated** | 6 agencies + 25 missions | Diverse, representative data |
| **Years of geochemistry data** | 50+ years (1967-2025) | Historical patterns for ML |
...
|--------|--------|---------|
| ✅ DONE | Project descriptions | EarthBank, Isotopes.au, LithoSpace documented |
...
| **HIGH** | Obtain RMIT/UniMelb collaborator contact | Dr. Wayne Noble | `[NEEDS INFO]` |
...
| **LithoSpace** | RMIT Collaborator | `[NEEDS INFO]` | `[NEEDS INFO]` |
...
*Document Version: 5.0 - Updated 2025-11-30*
*Restructured to 3 projects (EarthBank, Isotopes.au, LithoSpace) - removed LithoSurfer as internal product*
