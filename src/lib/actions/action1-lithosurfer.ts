...
**Pricing:** FREE`
  },
  {
    ...
    helpText: 'Click tags to select features for the Free tier. Selected features will be automatically included in Pro and Enterprise tiers.',
    required: true
  },
...
**Pricing:** $1K-10K per seat annually`
  ...
  },
  {
    ...
    inheritSelectionsFrom: ['lithosurfer_free_tools'],
    helpText: 'Click additional tags to add to Pro tier. Features selected in Free tier are automatically included (shown with 🔒).',
    required: true
  },
...
**Pricing:** Custom quotes ($25K+ annually)`
  ...
  },
  {
    ...
    inheritSelectionsFrom: ['lithosurfer_free_tools', 'lithosurfer_pro_tools'],
    helpText: 'Click additional tags to add to Enterprise tier. Features from Free and Pro tiers are automatically included (shown with 🔒).',
    required: true
  },

  // Implementation Assessment
  {
    id: 'lithosurfer_sellables_match',
    section: '1.4 Implementation Requirements',
    question: 'What about this plan does not match our "sellables"?',
    type: 'textarea',
    rows: 4,
    helpText: 'Review the Sellables document at: /Users/keithdimech/Pathway/Dev/Lithodat/Viable Systems Model/build-data/assets/Sellables We Can Offer NOW.pdf',
    placeholder: 'Identify gaps between the three-tier plan and our current sellable offerings...',
    required: true
  },
  {
    id: 'lithosurfer_additional_tools',
    section: '1.4 Implementation Requirements',
    question: 'What are additional tools that could be built to enhance the three tier model?',
    type: 'textarea',
    rows: 4,
    placeholder: 'Suggest new tools or features that would strengthen the offering at each tier...',
    required: true
  },
  {
    id: 'lithosurfer_ux_changes',
    section: '1.4 Implementation Requirements',
    question: 'What UX changes are needed to suit Lithosurfer Model? Should it match UX of Earthbank or target our customer base?',
    type: 'textarea',
    rows: 4,
    placeholder: 'Discuss UX approach, alignment with Earthbank, and customer-specific needs...',
    required: true
  },
  {
    id: 'lithosurfer_mvp',
    section: '1.4 Implementation Requirements',
    question: 'What is our MVP before we can sign up our first customer?',
    type: 'textarea',
    rows: 4,
    placeholder: 'Define the minimum viable product and essential features needed to onboard the first paying customer...',
    required: true
  },
  {
