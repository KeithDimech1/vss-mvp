      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          ...
          <p className="text-gray-600">
            Review team responses and build consensus on final OKR implementation decisions
          </p>
        </div>
        ...
        <div className="mt-6 bg-[#F5E6D3]/30 border border-[#C9A961]/40 rounded-lg p-6">
          <h3 className="font-bold text-blue-900 mb-2">How to Build Consensus on OKR Framework</h3>
          <ul className="list-disc list-inside text-sm text-blue-800 space-y-1">
            <li>Review each team member's preferences for OKR framework, time horizons, and priorities</li>
            <li>Discuss differences - this is your chance to align on execution methodology</li>
            <li>Enter the agreed-upon consensus decision for each framework element</li>
            <li>Remember: This decision affects how the entire company will track and achieve goals</li>
            <li>Your changes auto-save every 30 seconds</li>
            <li>Mark as "Resolved" when consensus is reached and you're ready to implement</li>
          </ul>
        </div>
      </div>
    </div>
