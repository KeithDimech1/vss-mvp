...
export default function DashboardLayout({
  ...
  // Check if user can access GDAC Tender (managers + specific users)
  const canAccessGdacTender = isManager || ['qusay'].includes((session?.username || '').toLowerCase());
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-[#F5E6D3]/20 to-[#C9A961]/10">
      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-[#1B4332] to-[#0F2922] text-white shadow-2xl">
        ...
        <nav className="mt-6">
          ...
          {/* GDAC Tender Tracker - accessible by managers and specific users */}
          {canAccessGdacTender && (
            <Link
              href="/gdac-tender"
              className="block px-6 py-3 hover:bg-[#C9A961]/20 transition-all duration-200 border-l-4 border-transparent hover:border-[#C9A961] text-[#F5E6D3]/80 hover:text-white"
          ...
          <div className="px-8 py-5 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              {isManager && (
                <Link
                  href="/hr-review"
                  className="px-5 py-2.5 bg-[#1B4332] text-white rounded-lg hover:bg-[#0F2922] transition-all duration-200 shadow-md hover:shadow-lg font-medium flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
