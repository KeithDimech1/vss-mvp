...
This form provides comprehensive company identification and ownership information as required by the Saudi Geological Survey for pre-qualification in the GDAC-SA Advanced Analytics Platform tender.

---

## Section A: Company Identification

### A.1 Basic Company Information
...
### A.2 Registration Numbers

| Field | Response | Source/Notes |
|-------|----------|--------------|
| **Australian Business Number (ABN)** | 63 627 008 904 | Primary Australian identifier |
| **Tax File Number (TFN)** | 452 382 055 | Australian tax identifier |
...
### A.3 Foreign Investment Registration (Required for Non-Saudi Entities)
...
> - (b) Form consortium with Saudi-registered partner who holds this license

---

## Section B: Capital and Financial Standing
...
## Section C: Establishment and History
...
## Section F: Company Ownership Structure

### F.1 Ownership Summary
...
## Section G: Company Representative for This Application

### G.1 Designated Contact Person

| Field | Response | Notes |
|-------|----------|-------|
| **Name of Responsible Person** | Keith Dimech | COO - Primary tender contact |
| **Job Title/Position** | Chief Operating Officer | Executive team member |
| **Authority Level** | Authorized Signatory (Delegated by Directors) | Can sign on behalf of company for tender |

### G.2 Contact Details for Representative
...
## Section H: Consortium Information (If Applicable)

### H.1 Consortium Status

| Field | Response |
|-------|----------|
| **Applying as Consortium?** | No |
| **Lead Partner** | N/A - Solo application by Lithodat Pty Ltd |
| **Number of Partners** | N/A |

Lithodat Pty Ltd is applying as a sole applicant, not as part of a consortium.

---

## Section I: Declaration and Certification

### I.1 Authorized Signatory Declaration

By signing below, the authorized signatory confirms that:

1. All information provided in this Applicant Information Form is true, complete, and accurate to the best of their knowledge.

2. The applicant company is duly authorized to submit this qualification application and has the legal capacity to enter into contracts with the Saudi Geological Survey.

3. The applicant understands and accepts all terms and conditions set forth in the Request for Qualifications (RFQ) document.

4. The applicant commits to maintaining confidentiality of any information obtained during the qualification process as required by RFQ Section 10.

5. The applicant has disclosed any potential conflicts of interest and will promptly notify SGS of any conflicts that may arise.

### I.2 Signature Block

| Field | Entry |
|-------|-------|
| **Signatory Name** | Dr. Fabian Kohlmann |
| **Position/Title** | Managing Director |
| **Signature** | `[TO BE SIGNED]` |
| **Date** | `[TO BE COMPLETED AT SUBMISSION]` |
| **Company Seal/Stamp** | `[TO BE AFFIXED]` |

---

## Attachments Required for Form 9.1
...
| Data Point | Source Document | Location |
|------------|-----------------|----------|
| Company Name, ABN, Address | FY2025 Annual Report | Cover page |
| TFN | Company Tax Return FY2025 | Page 1 |
| Industry Code | Company Tax Return FY2025 | Page 1 |
| Directors | FY2025 Annual Report | Directors' Report section |
| Capital/Equity Figures | FY2025 Annual Report | Balance Sheet |
| Tax Agent Details | FY2025 Tax Return | Cover page |
...
When entering this information into the Etimad platform:

1. **Language:** Enter all fields in both Arabic and English where possible
2. **Dates:** Use Islamic calendar (Hijri) dates where required, or Gregorian as specified
3. **Currency:** Convert AUD figures to SAR at current exchange rate (provide rate used)
4. **Documents:** Ensure all uploaded documents are searchable PDF format
5. **Attestation:** All copies must be stamped with company seal
